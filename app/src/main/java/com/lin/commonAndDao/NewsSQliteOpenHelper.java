...
public class NewsSQliteOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table if not exists news (id String,typeid String,typeid2 String,sortrank String," +
                "ismake String,channel String,arcrank String,click String,money String,title String,shorttitle String,writer String," +
                ...
                "voteid String,notpost String,description String,dutyadmin String,tackid String,mtype String,weight String,fby_id String," +
                ...
                "namerule2 String,ispart String,moresite String,sitepath String,arcurl String ,typeurl String)");
    }
